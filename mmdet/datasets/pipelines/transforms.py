...
class CopyPaste:
    ...
    def get_updated_masks(self, masks, composed_mask):
        assert masks.masks.shape[-2:] == composed_mask.shape[-2:], \
            'Cannot compare two arrays of different size:{shape1},{shape2}'.format(shape1 = masks.masks.shape[-2:],shape2 = composed_mask.shape[-2:])
